				...
				<?php include 'category.php'; ?>
					...
					<div class="col-md-9">
						<div class="row">
							...
							<div class="col-md-4 d-flex">
								<div class="product ftco-animate">
									<div class="img d-flex align-items-center justify-content-center" style="background-image: url(images/Cream/pro_6.jpg);">
										<div class="desc">
											<p class="meta-prod d-flex">
												<a href="#" onclick="return confirm('ยังไม่มีข้อมูล');" class="d-flex align-items-center justify-content-center"><span class="flaticon-shopping-bag"></span></a>
												<a href="#" onclick="return confirm('ยังไม่มีข้อมูล');" class="d-flex align-items-center justify-content-center"><span class="flaticon-visibility"></span></a>
									...
									<div class="text text-center">
										<span class="new">เพรชบูรณ์</span>
										<span class="category">ครีมบำรุง</span>
										<h2>โคลนเย็นพอกหน้าสาหร่ายทะเล ไวเทนนิ่ง ซี FACY</h2>
										<p class="mb-0"><span class="price price-sale">0.00 ฿</span> <span class="price">0.00 ฿</span></p>
									</div>
								</div>
							</div>
							<div class="col-md-4 d-flex">
								<div class="product ftco-animate">
									<div class="img d-flex align-items-center justify-content-center" style="background-image: url(images/Cream/pro_7.jpg);">
										<div class="desc">
											<p class="meta-prod d-flex">
												<a href="#" onclick="return confirm('ยังไม่มีข้อมูล');" class="d-flex align-items-center justify-content-center"><span class="flaticon-shopping-bag"></span></a>
												<a href="#" onclick="return confirm('ยังไม่มีข้อมูล');" class="d-flex align-items-center justify-content-center"><span class="flaticon-visibility"></span></a>
									...
									<div class="text text-center">
										...
										<span class="category">ครีมบำรุง</span>
										<h2>แชมพูอัญชันมะกรูด Jitima สมุนไพร</h2>
										<p class="mb-0"><span class="price price-sale">0.00 ฿</span> <span class="price">0.00 ฿</span></p>
									</div>
								</div>
							</div> -->
